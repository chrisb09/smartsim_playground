...
if not in_slurm_allocation():
    print("This script is meant to be run within a Slurm allocation. Please submit it using 'sbatch' or run it within an interactive Slurm session.")
    exit(1)
...
print(f"Using device: {'GPU' if use_gpu else 'CPU'} (device={device}, python_env={python_env})")


exp_dir = "exp_hello_world_cnn_interactive"
...
if False and ( exp.launcher == "slurm" or exp.launcher == "auto"):
