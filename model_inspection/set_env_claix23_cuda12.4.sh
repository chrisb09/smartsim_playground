...
# Local copy for a self-contained model_inspection; the SmartSim root is
# the parent of this directory.
MODEL_INSPECTION_DIR="$(cd "$(dirname "${BASH_SOURCE[0]:-}")" && pwd)"
SMARTSIM_ROOT_DIR="$(dirname "${MODEL_INSPECTION_DIR}")"
